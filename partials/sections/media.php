...
$media_items = array(
	array(
		'path' => '/bbs/board.php?bo_table=media&me_code=2010&wr_id=7',
	...
	array(
		'path' => '/bbs/board.php?bo_table=media&me_code=2010&wr_id=9',
	...
	array(
		'path' => '/bbs/board.php?bo_table=media&me_code=2010&wr_id=20&page=1',
...
<section class="section main-media">
	<div class="inner">
		...
		<div class="main-media-list">
			...
			<div class="main-media-slide">
				<a href="<?php echo $u($row['path']); ?>" target="_blank" rel="noopener noreferrer">
					<div class="thumb">
						<img src="/images/main/mainvisual/main-03-lawyer0<?php echo (int) ($i + 1); ?>.jpg" alt="<?php echo $e($row['thumb_alt']); ?>" width="380" height="240" loading="lazy">
		...
		<a href="<?php echo $u('/bbs/board.php?bo_table=media&me_code=2010'); ?>" class="view-more" target="_blank" rel="noopener noreferrer">View more<img src="/images/main/case_more_w.png" alt="미디어 보도자료 더보기" width="10" height="10" loading="lazy"></a>
	</div>
</section>
<!--//main-media -->
