...
<section class="quick-menu">
	...
	<ul class="quick-menu-pc">
		<li><a href="<?php echo $u('/page/self_test.php?me_code=7010&from=rthomas'); ?>" target="_blank" rel="noopener noreferrer" onmousedown="javascript:try{NA_Check();}catch(e){}"><img src="/images/common/quick_icon_self.png" alt="음주진단 자가진단" width="20" height="20">음주진단</a></li>
		...
		<li><a href="<?php echo $u('/bbs/board.php?bo_table=online&me_code=6010&from=rthomas'); ?>" target="_blank" rel="noopener noreferrer"><img src="/images/common/quick_icon03.png" alt="온라인 상담 신청" width="20" height="20">온라인 상담</a></li>
	...
	<ul class="quick-menu-mo">
		<li><a href="<?php echo $u('/page/self_test.php?me_code=7010&from=rthomas'); ?>" target="_blank" rel="noopener noreferrer"><img src="/images/common/quick_icon_self.png" alt="음주진단 자가진단">음주진단</a></li>
		...
		<li><a href="<?php echo $u('/bbs/board.php?bo_table=online&me_code=6010&from=rthomas'); ?>" target="_blank" rel="noopener noreferrer"><img src="/images/common/quick_icon03.png" alt="온라인 상담 신청">온라인 상담</a></li>
