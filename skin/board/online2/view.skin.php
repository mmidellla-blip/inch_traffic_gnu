...
<article id="bo_v" style="width:<?php echo $width; ?>">
   <div class="bo_header">
    ...
    <div class="bo_w_select write_div">
      <div class="label">운전면허 취소처분 통지서를 받고 며칠이 지났나요?</div>
      <div class="val"><?php echo $view['wr_6'];?></div>
    </div>
    <div class="bo_w_select write_div">
      <div class="label">적발 당시 혈중알코올농도 수치는 얼마였나요?</div>
      <div class="val"><?php echo $view['wr_7'];?></div>
    </div>
    <div class="bo_w_select write_div">
      <div class="label">과거 음주운전으로 적발된 적이 있으셨나요?</div>
      <div class="val"><?php echo $view['wr_3'];?></div>
    </div>
    <div class="bo_w_select write_div">
      <div class="label">음주운전 적발 당시 해당되는 내용이 있으셨나요?</div>
      <div class="val"><?php echo $view['wr_4'];?></div>
    </div>
    <div class="bo_w_select write_div">
      <div class="label">음주운전 당시 교통사고가 발생했나요?</div>
      <div class="val"><?php echo $view['wr_5'];?></div>
    </div>
    <div class="bo_w_select write_div">
      <div class="label">현재 운전면허가 필요한 직업을 갖고 계신가요?</div>
      <div class="val"><?php echo $view['wr_8'];?></div>
    </div>
