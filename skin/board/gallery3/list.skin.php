...
// 썸네일 크기 설정
$thumb_width = '260';    //썸네일 넓이
$thumb_height = '260';    //썸네일 높이

// add_stylesheet('css 구문', 출력순서); 숫자가 작을 수록 먼저 출력됨
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/template.css">', 0);
?>
...
<!--		<h1 class="sub-conts-title">고객의 신뢰는 <span>오직 성공 사례</span>에 의해 만들어 집니다.</h1>-->
...
<!-- 		<div class="bo_fx">
	...
	*/
			 ?>
 			<li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>>
				<!-- 제목,내용 출력 -->
				<a href="<?php echo $list[$i]['href'] ?>">
                    ...
                    <?php } else {
                        ...
                        if($thumb['src']) {
                            ...
                            $img_content = '<div class="thum"><img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" ></div>';
                        } else {
					...
					<?php
					if (!$list[$i]['is_notice']) {  // 공지사항은 분류출력 안함 ?>
					<div class="board01-txt-area">
				...
				<!--	<span class="date"><?php echo substr($list[$i]['wr_datetime'],0,10) ?></span></div>-->
