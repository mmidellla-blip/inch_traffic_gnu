...
<!-- 			조회<strong><?php echo number_format($view['wr_hit']) ?>회</strong>
		...
		<section id="bo_v_atc">
			...
			<!-- 본문 내용 시작 { -->
			<div id="bo_v_con">
			직책:<br> <?php echo get_view_thumbnail($view['wr_7']); ?> </br></br>		
			전문변호사:<br> <?php echo get_view_thumbnail($view['wr_8']); ?> </br></br>	
			주요업무:<br> <?php echo get_view_thumbnail($view['wr_9']); ?> </br></br>

				
			학력:<br> <?php echo nl2br(get_view_thumbnail($view['wr_3'])); ?> </br></br>
			경력:<br><?php echo nl2br(get_view_thumbnail($view['wr_4'])); ?> </br></br>
			
			
			
<!--		활동:<br><?php echo nl2br(get_view_thumbnail($view['wr_2'])); ?> </br></br>
			저서:<br><?php echo nl2br(get_view_thumbnail($view['wr_11'])); ?> </br></br>
			강조내용:<br><?php echo get_view_thumbnail($view['wr_12']); ?>  </br></br>
			이메일:<br><?php echo nl2br(get_view_thumbnail($view['wr_6'])); ?> </br></br>
		-->
			출력순서: <?php echo get_view_thumbnail($view['wr_1']); ?>
			</div>
