...
<!-- 			<div id="bo_list_total">
		...
		<div class="tbl_head01 tbl_wrap">
			...
			<tr>
				...
				<th scope="col" width="30%"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>등록일<i class="fa fa-sort" aria-hidden="true"></i></a></th>
			</tr>
			</thead>
			<tbody>
			<?php
			...
			<tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
				...
				if ($is_category && $list[$i]['ca_name']) {
				 ?>
				<td><a href="<?php echo $list[$i]['ca_name_href'] ?>" class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?></a></td>
				<?php } ?>
