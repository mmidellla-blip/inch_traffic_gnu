...
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/board_tem1.css">', 1);
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/board_tem2.css">', 1);
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/board_tem3.css">', 1);
?>
