...
<section class="sub-conts-wrap">
	...
	<section id="bo_w">
		...
		<div class="bo_w_tit write_div">
			<label for="wr_subject" class="sound_only">변호사 이름<strong>필수</strong></label>
		...
		<div class="bo_w_select write_div">
			<label for="ca_name"  class="sound_only">변호사 직책<strong>필수</strong></label>
			<select name="ca_name" id="ca_name" required>
				<option value="">변호사 직책을 선택하세요</option>
				<option value="대표변호사" <?php echo $ca_name=="대표변호사"?"selected":"" ?> >대표변호사</option>
				<option value="변호사" <?php echo $ca_name=="변호사"?"selected":"" ?> >변호사</option>
			</select>
		</div>
		...
		<div class="bo_w_info write_div">
				...
				<input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input" placeholder="연락처">
		</div>
