				...
				<div class="split full">
					<dl>
						...
						<dd>
							...
							<div class="filebox">
								<label for="wr_6">파일선택</label> 
								<input class="upload_name" value="첨부파일" disabled="disabled">
								<input type="file" id="wr_6" name="bf_file[1]" class="input input_file upload_hidden frm_file frm_input">
							</div>
							<div class="filebox">
								<label for="wr_7">파일선택</label> 
								<input class="upload_name" value="첨부파일" disabled="disabled">
								<input type="file" id="wr_7" name="bf_file[2]" class="input input_file upload_hidden frm_file frm_input">
							</div>
						</dd>
					</dl>
				</div>
