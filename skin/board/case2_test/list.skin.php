			...
			<li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>>
				...
				<a href="<?php echo $list[$i]['href'] ?>">
					...
					<div class="content-wrap">
                        ...
                        <?php echo utf8_strcut(strip_tags($list[$i]['wr_1']), 300, '..'); ?></p>
						<?php
							if (!$list[$i]['is_notice']) { // 공지사항이 아닐경우 내용출력 ?>
							<span class="bo-content"><?php echo utf8_strcut(strip_tags($list[$i]['wr_1']), 300, '..'); ?></p></span>
						<?php } ?>

								<span class="more">자세히보기<img src="/images/main/board_arrow.png" alt=""></span>
