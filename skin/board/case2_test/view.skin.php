		...
		<section id="bo_v_atc">
			...
			if($v_img_count) {
				echo "<div id=\"bo_v_img\">\n";
					...
					//if ($view['file'][$i]['view']) {
					if ($view['file'][0]['view'] && !preg_match("/변호사/",$view['file'][0]['bf_content'])) {
			 ...
			 ?>
          <div class="sub-text">
         	  <h4 class="simple-title"><?php echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력 ?></h4>    
		 	  <h3 class="simple-subtitle"><?php echo $view['wr_5']; ?></h3>
              
          </div>


          <div class="sub-text">
           <h3><img src="/images/sub/step1.jpg"</h3>
	       <h4>사건 경위</h4>    
              <p><?php echo get_view_thumbnail($view['wr_1']); ?></p>
              
          </div>
          <div class="sub-text">
           
            <h3><img src="/images/sub/step2.jpg"</h3>
			<h4>사건의 쟁점</h4>    
            <p><?php echo get_view_thumbnail($view['wr_2']); ?></p>
          </div>
          <div class="sub-text">
           
            <h3><img src="/images/sub/step3.jpg"</h3>
			<h4>변호사의 노력</h4>  
              <p><?php echo get_view_thumbnail($view['wr_3']); ?></p>
          </div>
        </div>
        <div class="sub-text">
           
            <h3><img src="/images/sub/step4.jpg"</h3>
			<h4>이 사건 수사기관의 판단</h4>  
              <p><?php echo get_view_thumbnail($view['wr_6']); ?></p>
          </div>
        </div>
        <div class="sub-text">
           
            <h3><img src="/images/sub/step5.jpg"</h3>
			<h4>결론</h4>  
              <p><?php echo get_view_thumbnail($view['wr_7']); ?></p>
          </div>
        </div>
		<?php
			// 파일 출력
			...
			if($v_img_count) {
				echo "<div id=\"bo_v_img\">\n";
					...
					//if ($view['file'][$i]['view']) {
					if ($view['file'][1]['view'] && !preg_match("/변호사/",$view['file'][1]['bf_content'])) {
						//echo $view['file'][$i]['view'];
