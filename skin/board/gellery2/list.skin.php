...
<!-- 		<div class="bo_fx">
	...
	*/
			...
			<li class="swiper-slide" <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>>
				<!-- 제목,내용 출력 -->
				<a href="<?php echo $list[$i]['href'] ?>">
					...
					<div class="conts-wrap">
						...
						<?php } ?>
						 <div class="date">
							<span class="month"><?php echo date("20y.m", strtotime($list[$i]['wr_datetime'])) ?></span>
							<span class="day"><?php echo date("d", strtotime($list[$i]['wr_datetime'])) ?></span>
						 </div>
						...
						<?php
							...
							$wr_content = str_replace("BODY CONTENT","",$wr_content);
							$wr_content = str_replace("본문 내용","",$wr_content);
			...
			<!--					
							<ul class="name">
								...
								?>
									<li><strong>사건 담당</strong><?php echo $lawyer_row["wr_subject"] ?> <?php echo $lawyer_row["ca_name"] ?></li>
									<li>
