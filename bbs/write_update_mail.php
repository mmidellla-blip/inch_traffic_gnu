...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
       ...
       <span style="display:block;padding:10px 30px 2px;background:#f7f7f7;text-align:left">
            이름 <?php echo $wr_name ?>
        </span>
        <span style="display:block;padding:5px 30px 2px;background:#f7f7f7;text-align:left">
            문의분야 : <?php echo $mail_wr_cate ?>
        </span>
        <span style="display:block;padding:5px 30px 2px;background:#f7f7f7;text-align:left">
            연락처 : <?php echo $mail_wr_tel ?>
        </span>
        <span style="display:block;padding:5px 30px 15px;background:#f7f7f7;text-align:left">
            이메일 : <?php echo $mail_wr_email ?>
        </span>
        <span style="display:block;padding:5px 30px 15px;background:#f7f7f7;text-align:left">
            CGLID : <?php echo $mail_wr_cglid; ?>
        </span>
