...
<section class="sub-conts-wrap">
	<h1 class="sub-conts-title title-h1"><span><?php echo $g5['title']; ?></span></h1>
		...
		<section class="location-detail">
			...
			<section class="location-inner on">
				...
				<section class="location-address">
					<h3 class="title-h3"><span>Location</span>서울사무소</h3>
			...
			<section class="location-inner">
				...
				<section class="location-address">
					<h3 class="title-h3"><span>Location</span>수원사무소</h3>
					<section class="location-address-wrap">
			...
			<section class="location-inner">
				...
				<section class="location-address">
					<h3 class="title-h3"><span>Location</span>인천사무소</h3>
					<section class="location-address-wrap">
