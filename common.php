...
function g5_path()
{
    // Hostinger 등: SCRIPT_FILENAME에 프로젝트 경로가 안 잡히면 strpos=false → PHP 8에서 substr TypeError → HTTP 500
...
if (file_exists($dbconfig_file)) {
    ...
    include_once(G5_LIB_PATH.'/error_handler.lib.php'); // HTTP 상태 코드 기반 오류 처리 (404/403/503/301)
